                        ...
                        if(ot_data.length > 0) {
                            ot_data.forEach(function(key, data) {
                                ...
                                for(let i in key) {
                                    ...
                                    let from_input = '<input type="text" class="form-control form-control-sm date_time" placeholder="YYYY-MM-DD HH:MM" value="'+ obj.from_24+'" >';
                                    let to_input = '<input type="text" class="form-control form-control-sm date_time" placeholder="YYYY-MM-DD HH:MM" value="'+obj.to_24+'" >';
