    ...
    <script>
        $(document).ready(function() {
            ...
            function fill_dept_wise_table(company, area, location, dept, date){
                let f_in_date = date + 'T08:00';
                let f_out_date = date + 'T17:00';
                    ...
                    success: function(res) {
                        ...
                        for(let i = 0; i < res.length; i++)
                        {
                            t.row.add([
                                ...
                                '<input type="datetime-local" class="form-control form-control-sm" value="'+f_in_date+'" name="in_time[]" /> ' +
                                '<input type="hidden" value="'+res[i].emp_id+'" name="emp_id[]" /> ',
                                '<input type="datetime-local" class="form-control form-control-sm" value="'+f_out_date+'" name="out_time[]" /> '
