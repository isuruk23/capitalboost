            ...
            <div class="card-body p-0 p-2">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-row mb-1 mt-5" id="working_wd_table">
                            <div class="col">
                                <h5>Working Work days breakdown</h5>
                                <label class="mr-4">
                                    <badge class="badge badge-pill " style="background-color: #DEF7ED"> &nbsp; </badge> : Full Days
                                </label>
                                <label class="mr-4">
                                    <badge class="badge badge-pill " style="background-color: #FDE5D0"> &nbsp; </badge> : Half Days
                                </label>
                                <label class="mr-4">
                                    <badge class="badge badge-pill " style="background-color: #EEB7B8"> &nbsp; </badge> : Leave Days
                                </label>
