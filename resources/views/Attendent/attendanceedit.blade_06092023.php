                                ...
                                <form method="post" id="formAdd" class="form-horizontal">
                                    ...
                                    <div class="form-row mb-1">
                                        <div class="col">
                                            ...
                                            <input type="text" name="in_time_s" id="in_time_s" class="form-control form-control-sm" placeholder="YYYY-MM-DD HH:MM" />
                                        </div>

                                        <div class="col">
                                            <label class="small font-weight-bold text-dark">Out Time</label>
                                            <input type="text" name="out_time_s" id="out_time_s" class="form-control form-control-sm" placeholder="YYYY-MM-DD HH:MM" />
                                        </div>
                        ...
                        if (res.status == 1) {
                            ...
                            for(let i = 1; i <= num_of_days; i++)
                            {
                                ...
                                t.row.add([
                                    i,
                                    day,
                                    '<input type="text" class="form-control form-control-sm in_date_time" placeholder="YYYY-MM-DD HH:MM" id="in_'+i+'" name="in_time[]" /> ' +
                                    ...
                                    '<input type="text" class="form-control form-control-sm out_date_time" placeholder="YYYY-MM-DD HH:MM" id="out_'+i+'" name="out_time[]" /> '
                                ]).node().id = i;
                                t.draw( false );
                            }
