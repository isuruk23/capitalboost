            ...
            $('#formFilter').on('submit',function(e) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if(ot_data.length > 0) {
                            ot_data.forEach(function(key, data) {
                                ...
                                for(let i in key) {
                                    ...
                                    let from_input = '<input type="datetime-local" class="form-control form-control-sm date_time" placeholder="YYYY-MM-DD HH:MM" value="'+ obj.from_24+'" >';
                                    let to_input = '<input type="datetime-local" class="form-control form-control-sm date_time" placeholder="YYYY-MM-DD HH:MM" value="'+obj.to_24+'" >';
                                    ...
                                    ot_data_html += '<td>'+ one_point_five_hours_input +'</td>';
                        ...
                        ot_data_html += '</tbody>';
                        ot_data_html += '</table>' + '<div class="form-group mt-3 ">' + '<button type="button" class="btn btn-primary btn-sm float-right" id="btn_approve_ot">Approve</button>' + '</div>';
                        // console.log(ot_data_html);
