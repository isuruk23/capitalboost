                        ...
                        if(ot_data.length > 0) {
                            ot_data.forEach(function(key, data) {
                                ...
                                for(let i in key.ot_breakdown) {
                                    ...
                                    let one_point_five_hours_input = '<input type="number" class="form-control form-control-sm" value="'+obj.one_point_five_rate_otwork_hrs+'" step=".01" readonly>';
