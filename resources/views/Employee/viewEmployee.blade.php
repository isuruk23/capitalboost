								...
								<div class="card-body bg-light">
									...
									<div class="form-row">
										...
										<div class="col">
											...
											<select name="province" class="form-control form-control-sm {{ $errors->has('province') ? ' has-error' : '' }} shipClass">
												<option value="">Select</option>
												@foreach($provinces as $province)
												<option value="{{$province->id}}"
													{{$province->id == $employee->emp_province  ? 'selected' : ''}}>
										...
										<div class="col">
											<label class="small font-weight-bold text-dark">Zonal</label>
											<select name="zonal" class="form-control form-control-sm {{ $errors->has('zonal') ? ' has-error' : '' }} shipClass">
												<option value="">Select</option>
												@foreach($zonals as $zonal)
												<option value="{{$zonal->id}}"
													{{$zonal->id == $employee->emp_zonal  ? 'selected' : ''}}>
													{{$zonal->name}}</option>
												@endforeach
											</select>
											@if ($errors->has('zonal'))
											<span class="help-block">
												<strong>{{ $errors->first('zonal') }}</strong>
											</span>
											@endif
										</div>
										<div class="col">
											<label class="small font-weight-bold text-dark">Region</label>
											<select name="region" class="form-control form-control-sm {{ $errors->has('region') ? ' has-error' : '' }} shipClass">
												<option value="">Select</option>
												@foreach($regions as $region)
												<option value="{{$region->id}}"
													{{$region->id == $employee->emp_region  ? 'selected' : ''}}>
													{{$region->name}}</option>
												@endforeach
											</select>
