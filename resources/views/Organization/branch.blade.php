                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div class="form-group mb-1">
                                    <label class="small font-weight-bold text-dark">Target</label>
                                    <input type="text" name="target" id="target" class="form-control form-control-sm" />
                                </div>
