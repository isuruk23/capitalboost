                                                ...
                                                <table class="table table-bordered table-hover" id="emptable" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody class="">
                                                        ...
                                                        <tr id="row-{{$loan->employee_loan_id}}">
															...
															?>
                                                            	<input type="checkbox" class="freeze" data-refloan="{{$loan->employee_loan_id}}" data-refemp="{{$loan->payroll_profile_id}}" data-refid="{{$loan->installment_id}}"<?php echo $check_str; ?> />
