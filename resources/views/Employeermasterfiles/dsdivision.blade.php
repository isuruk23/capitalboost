                ...
                <div class="card-body p-0 p-2">
                    <div class="row">
                        <div class="col-12">
                                ...
                                <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add DS Division</button>
                ...
                },
                {
                    ...
                    "render": function (data, type, full) {
                        ...
                        var button = '';
                            ...
                            if (full['status'] == 1) {
                                button += ' <a href="dsdivisionstatus/' + full['id'] + '/2 " onclick="return deactive_confirm()" target="_self" class="btn btn-success btn-sm mr-1 "><i class="fas fa-check"></i></a>';
                            } else {
                                button += '&nbsp;<a href="dsdivisionstatus/' + full['id'] + '/1 "  onclick="return active_confirm()" target="_self" class="btn btn-warning btn-sm mr-1 "><i class="fas fa-times"></i></a>';
                            }
