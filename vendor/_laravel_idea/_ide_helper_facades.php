...
namespace Collective\Html {
     ...
     * @method static \Illuminate\Support\HtmlString select(string $name, array $list = [], string $selected = null, array $selectAttributes = [], array $optionsAttributes = [])
     ...
     * @method static \Illuminate\Support\HtmlString getSelectOption(string $display, string $value, string $selected, array $attributes = [])
     ...
     * @method static \Illuminate\Support\HtmlString linkSecureAsset(string $url, string $title = null, array $attributes = [])
     ...
     * @method static \Illuminate\Support\HtmlString linkAction(string $action, string $title = null, array $parameters = [], array $attributes = [])
     ...
     * @method static \Illuminate\Support\HtmlString secureLink(string $url, string $title = null, array $attributes = [])
     ...
     * @method static \Illuminate\Support\HtmlString linkRoute(string $name, string $title = null, array $parameters = [], array $attributes = [])
     ...
     * @method static \Illuminate\Support\HtmlString linkAsset(string $url, string $title = null, array $attributes = [], bool $secure = null)
     */
    class HtmlFacade {}
}
...
namespace ConsoleTVs\Charts\Facades {
    ...
    /**
     * @see \ConsoleTVs\Charts\Builder::types
     * @method static array types(string $library = null)
     * @see \ConsoleTVs\Charts\Builder::realtime
     * @method static \ConsoleTVs\Charts\Builder\Realtime realtime(string $url, int $interval, string $type = null, string $library = null)
     * @see \ConsoleTVs\Charts\Builder::multiDatabase
     * @method static \ConsoleTVs\Charts\Builder\MultiDatabase multiDatabase(string $type = null, string $library = null)
     * @see \ConsoleTVs\Charts\Builder::libraries
     * @method static array libraries(string $type = null)
     * @see \ConsoleTVs\Charts\Builder::multi
     * @method static \ConsoleTVs\Charts\Builder\Multi multi(string $type = null, string $library = null)
     * @see \ConsoleTVs\Charts\Builder::database
     * @method static \ConsoleTVs\Charts\Builder\Database database(\Illuminate\Support\Collection $data, string $type = null, string $library = null)
     * @see \ConsoleTVs\Charts\Builder::assets
     * @method static string assets(array $libraries = [])
     * @see \ConsoleTVs\Charts\Builder::create
     * @method static \ConsoleTVs\Charts\Builder\Chart create(string $type = null, string $library = null)
     * @see \ConsoleTVs\Charts\Builder::styles
     * @method static string styles(array $libraries = [])
     * @see \ConsoleTVs\Charts\Builder::math
     * @method static \ConsoleTVs\Charts\Builder\Math math(string $function, array $interval, int $amplitude, string $type = null, string $library = null)
     * @see \ConsoleTVs\Charts\Builder::scripts
     * @method static string scripts(array $libraries = [])
     */
    class Charts {}
}
...
namespace Illuminate\Support\Facades {
     ...
     * @see \Illuminate\Foundation\Application::makeWith
     ...
     * @method static void connection(string $name = null)
     */
    class Broadcast {}
     ...
     * @method static void put(string $key, $value, \DateTime|float|int $minutes)
     * @see \Illuminate\Contracts\Cache\Repository::remember
     * @method static mixed remember(string $key, \DateTime|float|int $minutes, \Closure $callback)
     * @see \Illuminate\Contracts\Cache\Repository::has
     * @method static bool has(string $key)
     * @see \Illuminate\Contracts\Cache\Repository::add
     * @method static bool add(string $key, $value, \DateTime|float|int $minutes)
     ...
     * @method static void putMany(array $values, float|int $minutes)
     ...
     * @method static \Illuminate\Database\Connection setReadPdo($pdo)
     ...
     * @method static \Illuminate\Http\Request setJson(array $json)
     ...
     * @see \Illuminate\Http\Concerns\InteractsWithInput::intersect
     ...
     * @method static \Psr\Log\LoggerInterface useSyslog(string $name = 'laravel', string $level = 'debug', $facility = LOG_USER)
     ...
     * @method static mixed later(int $delay, array|string $view, array $data = [], \Closure|string $callback = null, null|string $queue = null)
     * @see \Illuminate\Support\Traits\Macroable::hasMacro
     * @method static bool hasMacro(string $name)
     ...
     * @method static void send(array|string $view, array $data = [], \Closure|string $callback = null)
     ...
     * @method static mixed queue(array|string $view, array $data = [], \Closure|string $callback = null, null|string $queue = null)
     */
    class Mail {}
     ...
     * @method static mixed later(\DateTime|int $delay, string $job, $data = '', string $queue = null)
     ...
     * @method static mixed push(string $job, $data = '', string $queue = null)
     ...
     * @method static bool put(string $path, resource|string $contents, string $visibility = null)
