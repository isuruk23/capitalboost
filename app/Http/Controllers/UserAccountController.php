...
class UserAccountController extends Controller
{
    ...
    public function get_employee_monthlysummery(Request $request)
    {
        ...
        $work_days = (new \App\Attendance)->get_work_days($empid, $selectedmonth, $lastDate);
	
       	$working_week_days_arr = (new \App\Attendance)->get_working_week_days($empid, $selectedmonth, $lastDate)['no_of_working_workdays'];
                        
     	$leave_days = (new \App\Attendance)->get_leave_days($empid, $selectedmonth, $lastDate);
		
		$no_pay_days = (new \App\Attendance)->get_no_pay_days($empid, $selectedmonth, $lastDate);
		...
		$sqlslip = DB::table('employee_payslips')
		->join('payroll_profiles', 'employee_payslips.payroll_profile_id', '=', 'payroll_profiles.id')
...
dd($sqlslip);
        ...
        // return response() ->json(['result'=>  $attendance_responseData]);
