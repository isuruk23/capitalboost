...
//            'no_of_annual_leaves'  => 'required_if:status,2'
    ...
    public function show($id)
    {
        ...
        $zonals = Zonal::orderBy('id', 'asc')->get();
        ...
        return view('Employee.viewEmployee', compact( 'job_categories', 'employee', 'id', 'jobtitles', 'employmentstatus', 'branch', 'provinces','zonals','regions','shift_type', 'company', 'departments', 'work_categories'
    ...
    public function edit(REQUEST $request)
    {
        ...
        $employee->emp_zonal = $zonal;
        $employee->emp_region = $region;
