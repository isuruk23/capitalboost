...
//        $name->disconnect();
    ...
    public function attendance_list_for_approve(Request $request)
    {
        ...
        // $query->where(['employees.emp_id' => 1033]);
        ...
        $current_date_time = Carbon::now()->toDateTimeString();
            ...
            $records = DB::select($query3 . $query2 . $query6);
                ...
                foreach ($records as $record) {
                    ...
                    $nopayamount = (new \App\Employeelateattenadnaceminites)->testNopay($record->emp_id, $work_days,$leave_days,$no_pay_days,$normal_ot_hours, $double_ot_hours);
    ...
    public function lateAttendance_mark_as_late_approve(Request $request)
    {
        ...
        foreach ($selected_cb as $cr) {
            ...
            // set approve type
            if(isset($leave_type) &&  $leave_type == 7){
    ...
    public function delete(Request $request)
    {
        ...
        return response()->json([ 'success' => true, 'status' => $status,'msg' => 'Deleted']);
