...
Route::get('/customerdashboard' ,'CustomerdashboardController@index')->name('customerdashboard');
...
Route::get('/getcustomerdashboard_CustomerChart', 'CustomerdashboardController@getcustomerdashboard_CustomerChart')->name('getcustomerdashboard_CustomerChart');
...
Route::get('/quotation', 'QuotationController@create')->name('quotation');
Route::post('/quotations', 'QuotationController@store')->name('quotations.store');
Route::post('/quotationsupdate', 'QuotationController@update')->name('quotations.update');
Route::get('/Quotations/{id}/edit', 'QuotationController@edit')->name('quotations.edit');
Route::get('/Quotations/{id}/delete', 'QuotationController@destroy')->name('quotations.delete');
Route::get('/quotationdashboard' ,'QuotationController@dashboard')->name('quotations.dashboard');
Route::get('/quotationsview' ,'QuotationController@quotationsview')->name('quotationsview');

Route::get('/quotaionappove' ,'QuotationController@quotaionappove')->name('quotaionappove');
Route::get('/quotaionappovedview' ,'QuotationController@quotaionappovedview')->name('quotaionappovedview');
Route::get('/installmentpayments' ,'InvestmentController@installmentpayments')->name('installmentpayments');
Route::get('/generatequotation/{id}' ,'QuotationController@generatequotation')->name('generatequotation');
Route::get('/quotaionview/{id}', 'QuotationController@show');
Route::post('/quotationsapprovel', 'QuotationController@approvel')->name('quotationsapprovel');
Route::get('/getinvestmentplans', 'QuotationController@getplans');
Route::get('/getinvestmentsubplans/{id}', 'QuotationController@getsubplans');

Route::resource('investmentplans', 'InvestmentPlanController');
Route::get('/investmentplans', 'InvestmentPlanController@index')->name('investmentplans');
Route::post('/investmentplans/store', 'InvestmentPlanController@store')->name('investmentplans.store');
Route::get('/investmentplans/{id}/show', 'InvestmentPlanController@show');
Route::put('/investmentplans/{id}', 'InvestmentPlanController@update')->name('investmentplans.update');

// Route::delete('/investmentplans/{id}', 'InvestmentPlanController@destroy');
...
Route::get('/investmentupdate', 'InvestmentController@update')->name('investment.update');
Route::get('/investment/{id}/show', 'InvestmentController@show')->name('investments.show');
Route::get('/investment/{id}/edit', 'InvestmentController@edit')->name('investments.edit');
Route::get('/investment/{id}/destroy', 'InvestmentController@update')->name('investments.destroy');


Route::get('/generate-quotaion-pdf', 'InvestmentController@generatequotaion');
